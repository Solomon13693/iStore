  ...
  <div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-6">
            ...
            <p class="mb-0"> <?php echo $_SESSION['customer_name']; echo " ";  echo $_SESSION['customer'] ?> </p>
            ...
            <div class="shipping_address">
                ...
                <form class="mt-4" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <input type="text" name="city" placeholder="City" class="form-control" value="<?php echo isset($_POST["city"]) ? $city : "" ?>">
                            <div class="error_msg">
                                <?= $city_err ?>
                            </div> 
                        </div>
