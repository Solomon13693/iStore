        ...
        <nav class="absolute md:relative w-64 transform -translate-x-full md:translate-x-0 h-screen overflow-y-scroll bg-black transition-all duration-300" :class="{'-translate-x-full': !navOpen}">
            <div class="flex flex-col justify-between h-full">
                <div class="p-4">
                    <!-- LOGO -->
                    <a class="flex items-center text-white space-x-4" href="index.php">
                        ...
                        <span class="text-2xl font-bold">iStore</span>
                    </a>
                    ...
                    <div class="py-4 text-gray-400 space-y-1">
                        <!-- BASIC LINK -->
                        <a href="index.php" class="block py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded">
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="add_product.php" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Add Products
                                </a>
                            </div>
                        </div>
                ...
                <div class="text-gray-200 border-gray-800 rounded flex items-center justify-between p-2">
                    ...
                    <a href="./adminFunction/logout.php?logout=true" class="hover:bg-gray-800 hover:text-white p-2 rounded">
